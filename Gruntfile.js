  ...
  grunt.initConfig({
    ...
    nwjs: {
      options: {
          ...
          macPlist: {
          	CFBundleURLTypes: [{CFBundleURLName: 'Obyte action', CFBundleURLSchemes: ['byteball-tn', 'obyte-tn']}],
      		/*CFBundleIconFile: 'nw.icns',*/
      		LSHasLocalizedDisplayName: 0,
      		UTExportedTypeDeclarations: [{
      			UTTypeIdentifier: 'org.obyte.coin-tn',
      			UTTypeDescription: 'Obyte Private Coin For Testnet',
      		...
      		CFBundleDocumentTypes: [{
      			...
      			LSItemContentTypes: ["org.obyte.coin-tn"],
